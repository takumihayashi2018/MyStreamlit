...
import pandas as pd
import numpy as np
from pages.custom_module2.st_main import (
    MyStSessionState
    , Page, PageColumnSelection, PageLoad, PageSave, PageDataFrameDisplay, PageEditModule
)
...
class PivotTableApp:
    def __init__(self, df: pd.DataFrame, cols_measure: list):
        ...
        self.pages = {
            ...
            "Save": PageSave(self),
            "Edit Custom Module": PageEditModule(self)
